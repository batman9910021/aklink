...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN', '5983410560:AAEKAmMWmzQih3SIYYVnv1WyQUd7BW2C90A'))
    name = str(getenv('name', 'AK_Link_bot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1001889700449'))
    ...
    BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1001719006717")).split())) 
