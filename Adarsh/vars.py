...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'ubuntu.k786amirk.appboxes.co'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'ubuntu.k786amirk.appboxes.co:10054')) if not ON_HEROKU or getenv('FQDN', 'ubuntu.k786amirk.appboxes.co:10054') else APP_NAME+'.herokuapp.com'
